          ...
          >
            <div class="px-4 flex-none">
              <div class="" style="width: 90px; height: 90px">
                <img
                  src="{{ $item->product->galleries()->exists() ? Storage::url($item->product->galleries->first()->url) : 'data:image/gif;base64,R0lGODlhAQABAIAAAMLCwgAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw=='}}"                  alt="chair-1"
              ...
              <div class="flex flex-col mb-4">
                ...
                <div class="flex -mx-2 flex-wrap">
                  <div class="px-2 w-6/12 h-24 mb-4">
                    ...
                    >
                      <img
                        src="/frontend/frontend/images/content/logo-fedex.svg"
                        alt="Logo Fedex"
                  ...
                  <div class="px-2 w-6/12 h-24 mb-4">
                    ...
                    >
                      <img
                        src="/frontend/frontend/images/content/logo-dhl.svg"
                        alt="Logo dhl"
                        class="object-contain max-h-full"
                      />
                    </button>
              ...
              <div class="flex flex-col mb-4">
                ...
                <div class="flex -mx-2 flex-wrap">
                  <div class="px-2 w-6/12 h-24 mb-4">
                    ...
                    >
                      <img
                        src="/frontend/frontend/images/content/logo-midtrans.png"
                        alt="Logo midtrans"
                        class="object-contain max-h-full"
                      />
                    </button>
                  ...
                  <div class="px-2 w-6/12 h-24 mb-4">
                    ...
                    >
                      <img
                        src="/frontend/frontend/images/content/logo-mastercard.svg"
                        alt="Logo mastercard"
                      />
                    </button>
                  </div>
                  <div class="px-2 w-6/12 h-24 mb-4">
                    ...
                    >
                      <img
                        src="/frontend/frontend/images/content/logo-bitcoin.svg"
                        alt="Logo bitcoin"
                        class="object-contain max-h-full"
                      />
                    </button>
                  ...
                  <div class="px-2 w-6/12 h-24 mb-4">
                    ...
                    >
                      <img
                        src="/frontend/frontend/images/content/logo-american-express.svg"
